...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W2'] = np.random.normal(loc=0.0, scale=weight_scale, size=(num_filters*((H - 2)//2 + 1)*((W - 2)//2 + 1), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        d, grads['W3'], grads['b3'] = affine_backward(ds, cache3)
        d, grads['W2'], grads['b2'] = affine_relu_backward(d, cache2)
        d = np.reshape(d, (N, -1, (H-2)//2+1, (W-2)//2+1))
